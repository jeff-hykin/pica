...
export const isCanvasSymbol = Symbol('isCanvas');
export var isCanvas = function isCanvas(element) {
  let cname = objClass(element);
  
  return element[isCanvasSymbol] || cname === '[object HTMLCanvasElement]'/* browser */ ||
         cname === '[object OffscreenCanvas]' ||
         cname === '[object Canvas]'/* node-canvas */;
};


export var isImage = function isImage(element) {
  return objClass(element) === '[object HTMLImageElement]';
};


export var isImageBitmap = function isImageBitmap(element) {
  return objClass(element) === '[object ImageBitmap]';
};


export var limiter = function limiter(concurrency) {
  let active = 0,
      queue  = [];
...
export var cib_quality_name = function cib_quality_name(num) {
  switch (num) {
...
export var cib_support = function cib_support(createCanvas) {
...
export var worker_offscreen_canvas_support = function worker_offscreen_canvas_support() {
  return new Promise((resolve, reject) => {
...
export var can_use_canvas = function can_use_canvas(createCanvas) {
  let usable = false;
  try {
...
export var cib_can_use_region = function cib_can_use_region() {
...
export default {
    ...
    cib_quality_name,
    cib_support,
    worker_offscreen_canvas_support,
    can_use_canvas,
    cib_can_use_region,
}
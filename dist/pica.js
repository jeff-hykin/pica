            ...
            16: [
                function (_dereq_, module, exports) {
                    ...
                    module.exports.isCanvas = function isCanvas(element) {
                        ...
                        return (
                            cname === "[object HTMLCanvasElement]" ||
                            /* browser */
                ...
                function (_dereq_, module, exports) {
                    ...
                    MultiMath.prototype.init = function () {
                        ...
                        this.__init_promise = Promise.all(
                            Object.keys(self.__modules).map(function (name) {
            ...
            "/index.js": [
                function (_dereq_, module, exports) {
                    ...
                    Pica.prototype.__extractTileData = function (tile, from, opts, stageEnv, extractTo) {
                        if (
                            this.features.ww &&
                            CAN_USE_OFFSCREEN_CANVAS && // createImageBitmap doesn't work for images (Image, ImageBitmap) with Exif orientation in Chrome,
